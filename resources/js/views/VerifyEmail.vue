    ...
    <div class="column is-half card">
      <div class="card-content">
        <div class="content has-text-centered">
          ...
          <p>You must verify your email address (<i>{{ user.email }}</i>), to access batch link features</p>
          <hr />

          <article class="message is-success" v-if="resended">
            <div class="message-header">
              <p style="margin-bottom: 0;">Sended!</p>
              <button class="delete is-small" aria-label="delete" @click.prevent="resended = false"></button>
            </div>
